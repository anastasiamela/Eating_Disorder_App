...
class BehaviorLogDetailScreen extends StatefulWidget {
  static const routeName = '/behavior-log-detail';

  @override
  _BehaviorLogDetailScreenState createState() =>
      _BehaviorLogDetailScreenState();
}

class _BehaviorLogDetailScreenState extends State<BehaviorLogDetailScreen> {
  var _isInit = true;
  var _isLoading = true;
